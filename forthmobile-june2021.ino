...
#define PLATFORM_OPCODE_LIST \
  /* Memory Allocation */ \
  X("setuptof", setupe, setuptofinit()) \
  X("readlaser",sotape, PUSH readtof())  \
...
/*
Y(setuptof, PUSH 1 )    \   //  setuptofinit()) \
Y(readlaser, PUSH 1 )    \   //   PUSH readtof())  
*/
...
"\n"
"DEFINED? setuptof [IF]\n"
": setuptof1  setuptof cr .\" init laser \" cr ;\n"
"setuptof1\n"
"[THEN]\n"
"\n"
"internals definitions\n"
